...
function search() {
    ...
    // Search books in "Belum Baca" list
    searchBooksInList(listBelumBaca, searchInput);

    // Search books in "Sudah Baca" list
...
function searchBooksInList(bookList, searchTerm) {
    ...
    for (const book of books) {
        ...
        if (title.includes(searchTerm)) {
            ...
            document.getElementById('log-judul').style.display = 'none';
            document.getElementById('log-judul2').style.display = 'block';
            buttonBelumSelesai.checked = true;
            buttonSelesai.checked = true;
        } else {
            book.style.display = 'none';
            document.getElementById('search-input').value = '';
            document.getElementById('log-judul').style.display = 'block';
            document.getElementById('log-judul2').style.display = 'none';
        }
    }
}
